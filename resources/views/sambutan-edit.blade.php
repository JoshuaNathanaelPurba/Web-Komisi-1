...
<div class="max-w-2xl mx-auto px-4 py-12 text-left">
    ...
    <form action="#" method="POST" enctype="multipart/form-data" class="space-y-5 bg-white p-6 border border-gray-200 rounded-2xl shadow-sm">
        ...
        <div class="flex flex-col space-y-1.5">
            ...
            <input type="text" name="nama" value="[Nama Lama]" required class="w-full text-sm border-gray-300 rounded-xl focus:ring-pmkBlue focus:border-pmkBlue px-4 py-2.5">
        </div>

        <div class="flex flex-col space-y-1.5">
            <label class="text-sm font-bold text-slate-700 uppercase tracking-wider">Form Jabatan</label>
            <input type="text" name="jabatan" value="[Jabatan Lama]" required class="w-full text-sm border-gray-300 rounded-xl focus:ring-pmkBlue focus:border-pmkBlue px-4 py-2.5">
        </div>

        <div class="flex flex-col space-y-1.5">
            <label class="text-sm font-bold text-slate-700 uppercase tracking-wider">Form Periode</label>
            <input type="text" name="periode" value="[Periode Lama]" required class="w-full text-sm border-gray-300 rounded-xl focus:ring-pmkBlue focus:border-pmkBlue px-4 py-2.5">
        </div>

        <div class="flex flex-col space-y-1.5">
            <label class="text-sm font-bold text-slate-700 uppercase tracking-wider">Form Kata Sambutan</label>
            <textarea name="kata_sambutan" rows="5" required class="w-full text-sm border-gray-300 rounded-xl focus:ring-pmkBlue focus:border-pmkBlue px-4 py-2.5">[Isi kata sambutan lama...]</textarea>
        </div>
