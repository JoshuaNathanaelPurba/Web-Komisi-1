...
<div class="bg-white max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-8 text-left">
    ...
    <div class="border-b border-gray-100 pb-4">
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-900">Tambah Anggota</h2>
        ...
        <form action="{{ route('admin.anggota.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="space-y-1">
                ...
                <input type="file" id="foto" name="foto" required accept="image/*"
                       class="block w-full text-sm text-gray-900 mt-1 p-2 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
