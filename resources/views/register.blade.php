...
<body class="bg-gray-100 font-sans antialiased min-h-screen flex items-center justify-center">
    ...
    <div class="w-full min-h-screen grid grid-cols-1 md:grid-cols-2 shadow-2xl overflow-hidden">
        ...
        <div class="bg-[#3B4197] text-white flex flex-col items-center justify-center p-8 md:p-16 overflow-y-auto">
            <div class="w-full max-w-md bg-white/10 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20 my-8">
                
                <h1 class="text-3xl font-bold text-center mb-8 tracking-wide">DAFTAR</h1>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div class="text-sm text-right pt-2">
                        <span class="text-gray-100">Sudah punya akun?</span>
                        <a href="{{ route('login') }}" class="font-bold text-[#F28E2B] hover:underline ml-1">Masuk Sekarang</a>
                    </div>

                    <button type="submit" 
                        class="w-full py-3.5 mt-4 bg-[#F28E2B] hover:bg-[#d67b20] text-white font-bold rounded-xl shadow-lg transition duration-200 transform hover:scale-[1.02]">
                        DAFTAR
                    </button>
                </form>
        ...
        <div class="bg-[#F28E2B] text-white flex flex-col items-center justify-center p-8 md:p-12 space-y-4">
            <div class="w-24 h-24 bg-white rounded-full flex items-center justify-center text-[#F28E2B] font-bold text-sm shadow-lg">
                LOGO
            </div>
